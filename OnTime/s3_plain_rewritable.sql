create database t1;
use t1;
CREATE TABLE ontime UUID 'b86a87e9-e3c6-426d-a26b-1f62de8bf6a4'
(
...
ORDER BY FlightDate
SETTINGS
    disk = disk( type = 's3_plain_rewritable',
-- to write data: uncomment next line and remove UUID from create table
    readonly = true, no_sign_request = true, use_environment_credentials=false, skip_access_check = true,
    endpoint = 's3://altinity-clickhouse-data/airline/data/ontime_plain_rewritable/'
    )
;
